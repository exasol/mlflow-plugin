...
--/
CREATE OR REPLACE EXA_MLFLOW SCALAR SCRIPT "ARTIFACTS_LIST" (
...
--/
CREATE OR REPLACE EXA_MLFLOW SCALAR SCRIPT "EXPERIMENTS_SEARCH" (
  "connection_name" VARCHAR(2000000),
...
--/
CREATE OR REPLACE EXA_MLFLOW SCALAR SCRIPT "GATEWAY_ENDPOINTS_LIST" (
  "connection_name" VARCHAR(2000000),
...
--/
CREATE OR REPLACE EXA_MLFLOW SCALAR SCRIPT "GATEWAY_MODEL_DEFINITIONS_LIST" (
  "connection_name" VARCHAR(2000000),
  "provider" VARCHAR(2000000),
  "secret_id" VARCHAR(2000000)
) EMITS (
...
--/
CREATE OR REPLACE EXA_MLFLOW SCALAR SCRIPT "MODEL_VERSIONS_GET" (
  "connection_name" VARCHAR(2000000),
  "name" VARCHAR(2000000),
...
--/
CREATE OR REPLACE EXA_MLFLOW SCALAR SCRIPT "MODEL_VERSIONS_GET_DOWNLOAD_URI" (
  "connection_name" VARCHAR(2000000),
  "name" VARCHAR(2000000),
  "version" VARCHAR(2000000)
) EMITS (
...
--/
CREATE OR REPLACE EXA_MLFLOW SCALAR SCRIPT "MODEL_VERSIONS_SEARCH" (
  "connection_name" VARCHAR(2000000),
  "filter" VARCHAR(2000000),
  "order_by" VARCHAR(2000000),
  "max_results" DECIMAL(18,0)
...
--/
CREATE OR REPLACE EXA_MLFLOW SCALAR SCRIPT "REGISTERED_MODEL_GET" (
  "connection_name" VARCHAR(2000000),
  "name" VARCHAR(2000000)
) EMITS (
  "name" VARCHAR(2000000),
...
--/
CREATE OR REPLACE EXA_MLFLOW SCALAR SCRIPT "REGISTERED_MODELS_SEARCH" (
  "connection_name" VARCHAR(2000000),
  "filter" VARCHAR(2000000),
  "order_by" VARCHAR(2000000),
  "max_results" DECIMAL(18,0)
...
--/
CREATE OR REPLACE EXA_MLFLOW SCALAR SCRIPT "REGISTERED_MODELS_GET_LATEST_VERSIONS" (
  "connection_name" VARCHAR(2000000),
  "name" VARCHAR(2000000),
...
--/
CREATE OR REPLACE EXA_MLFLOW SCALAR SCRIPT "RUNS_SEARCH" (
  "connection_name" VARCHAR(2000000),
...
--/
CREATE OR REPLACE EXA_MLFLOW ADAPTER SCRIPT
