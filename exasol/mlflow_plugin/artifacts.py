...
class BucketFsArtifactRepo(ArtifactRepository):
    ...
    def log_artifact(self, local_file, artifact_path=None):
        ...
        print(f'BucketFsArtifactRepo.log_artifact(local_file={local_file}, artifact_path={artifact_path})')
    ...
    def download_artifacts(self, artifact_path, dst_path=None):
        ...
        print(f'BucketFsArtifactRepo.download_artifacts(artifact_path={artifact_path}, dst_path={dst_path})')
